...
> **This is the original 200S guide.** If you have a Core 300S, the [main README](README.md) is the 300S-specific guide (self-signed cert test, corrected `setSwitch` power command, firewall redirect, Home Assistant MQTT discovery).
